...
mod tests {
    ...
    fn test_resolve_model_path_not_found() {
        let dir = env::temp_dir().join("hermes-ssd-llm-test-resolve");
    ...
    fn test_resolve_model_path_exact() {
        let dir = env::temp_dir().join("hermes-ssd-llm-test-resolve-exact");
        let _ = fs::create_dir_all(&dir);
    ...
    fn test_resolve_model_path_with_ext() {
        let dir = env::temp_dir().join("hermes-ssd-llm-test-resolve-ext");
        let _ = fs::create_dir_all(&dir);
    ...
    fn test_handle_copy_missing_fields() {
        let dir = env::temp_dir().join("hermes-ssd-llm-test-copy");
        let _ = fs::create_dir_all(&dir);
    ...
    fn test_handle_delete_missing_name() {
        let dir = env::temp_dir().join("hermes-ssd-llm-test-delete");
        let _ = fs::create_dir_all(&dir);
    ...
    fn test_handle_delete_not_found() {
        let dir = env::temp_dir().join("hermes-ssd-llm-test-delete-nf");
        let _ = fs::create_dir_all(&dir);
